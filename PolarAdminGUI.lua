...
elseif game.PlaceId == 2788229376 or game.PlaceId == 16033173781 or game.PlaceId == 7213786345 then
...
Fluent:Notify({
    Title = "Polar Admin (Da Hood)",
    Content = "Polar Admin (Da Hood) Loaded!!",
    SubContent = "Join the discord!",
    Duration = 8
})
...
local Window = Fluent:CreateWindow({
    Title = "Polar Admin (Hood Customs) " .. Version,
    SubTitle = "by Polar Studios",
    TabWidth = 160,
    Size = UDim2.fromOffset(580, 460),
    Acrylic = false,
...
local Tabs = {
    ...
    Utilities = Window:AddTab({ Title = "Utilities", Icon = "settings" }),
    UniversalScripts = Window:AddTab({ Title = "Universal Scripts", Icon = "" }),
    hoodcustoms = Window:AddTab({ Title = "Hood Customs", Icon = "" }),
    Info = Window:AddTab({ Title = "Info", Icon = "info" })
}
...
local AzureModded = Tabs.hoodcustoms:AddButton({
        Title = "Azure Modded",
        Description = "Executes Azure Modded",
        Callback = function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/DaCoderMane/MyRobloxScripts/main/azuremoddedredirect.lua"))()
...
Fluent:Notify({
    Title = "Polar Admin (Hood Customs)",
    Content = "Polar Admin (Hood Customs) Loaded!!",
    SubContent = "Join the discord!",
    Duration = 8
})
