...
local characterstable={["a"]="🅐",["b"]="🅑",["c"]="🅒",["d"]="🅓",["e"]="🅔",["f"]="🅕",["g"]="🅖",["h"]="🅗",["i"]="🅘",["j"]="🅙",["k"]="🅚",["l"]="🅛",["m"]="🅜",["n"]="🅝",["o"]="🅞",["p"]="🅟",["q"]="🅠",["r"]="🅡",["s"]="🅢",["t"]="🅣",["u"]="🅤",["v"]="🅥",["w"]="🅦",["x"]="🅧",["y"]="🅨",["z"]="🅩",[" "]=" "};
...
local ExploitName = getexecutorname()
local ScriptName = "Abyss | Chat Bypasser"

local window = library:AddWindow(ScriptName.." | "..ExploitName, {
	main_color = Color3.fromRGB(41, 74, 122),
	min_size = Vector2.new(555, 555),
	can_resize = false,
})

local MainTab = window:AddTab("Main")
local BypassTab = window:AddTab("Bypass")
local WordPresets = window:AddTab("Words")
local SentencePresets = window:AddTab("Sentences")

MainTab.Show()

local MainTxt = MainTab:AddLabel("Thank you for using, Abyss | ChatBypasser V1.0")
local BypassTxt = BypassTab:AddLabel("Chat Bypass")
local WordPresetsTxt = WordPresets:AddLabel("Word Presets")
local SentencePresetsTxt = SentencePresets:AddLabel("Sentence Presets")

-- Main Tab

MainTab:AddButton("Join Discord",function()
...
BypassTab:AddTextBox("Text To Bypass", function(text)
	SendBypass(text)
end, {
	["clear"] = true,
})
...
WordPresets:AddButton("Discord",function()
	SendBypass("discord")
end)

WordPresets:AddButton("Fuck",function()
	SendBypass("fuck")
end)

WordPresets:AddButton("Nigger",function()
	SendBypass("nigger")
end)

WordPresets:AddButton("Nigga",function()
	SendBypass("nigga")
end)

WordPresets:AddButton("Faggot",function()
	SendBypass("faggot")
end)

WordPresets:AddButton("Cunt",function()
	SendBypass("cunt")
end)

WordPresets:AddButton("kys",function()
	SendBypass("kys")
end)

WordPresets:AddButton("Asshole", function()
    SendBypass("asshole")
end)

WordPresets:AddButton("Bullshit", function()
    SendBypass("bullshit")
end)

WordPresets:AddButton("Piss", function()
    SendBypass("piss")
end)

WordPresets:AddButton("Die", function()
    SendBypass("die")
end)

WordPresets:AddButton("Bastard", function()
    SendBypass("bastard")
end)

WordPresets:AddButton("Bitch", function()
    SendBypass("bitch")
end)

WordPresets:AddButton("Dyke", function()
    SendBypass("dyke")
end)

WordPresets:AddButton("Slut", function()
    SendBypass("slut")
end)

WordPresets:AddButton("Whore", function()
    SendBypass("whore")
end)

-- Sentence Presets

SentencePresets:AddButton("Cummy Wummy",function()
	SendBypass("cummy wummy")
end)

SentencePresets:AddButton("Kill yourself",function()
	SendBypass("kill yourself")
end)

SentencePresets:AddButton("Slit Your Wrists",function()
	SendBypass("slit your wrists")
end)

SentencePresets:AddButton("Piss off", function()
    SendBypass("piss off")
end)

SentencePresets:AddButton("Stupid nigger", function()
    SendBypass("stupid nigger")
end)

SentencePresets:AddButton("Let me squeeze them titties",function()
	SendBypass("let me squeeze them titties")
end)

SentencePresets:AddButton("Wana fuck?",function()
	SendBypass("wana fuck?")
end)

SentencePresets:AddButton("Go to pornhub.com for free robux",function()
	SendBypass("go to pornhub.com for free robux")
end)

SentencePresets:AddButton("Eat shit", function()
    SendBypass("eat shit")
end)

SentencePresets:AddButton("Dumb hoe", function()
    SendBypass("dumb hoe")
end)

SentencePresets:AddButton("Suck my dick", function()
    SendBypass("suck my dick")
end)

SentencePresets:AddButton("Fuck you", function()
    SendBypass("fuck you")
end)

SentencePresets:AddButton("You're an idiot", function()
    SendBypass("you're an idiot")
end)

SentencePresets:AddButton("Go to hell", function()
    SendBypass("go to hell")
end)

SentencePresets:AddButton("Screw you", function()
    SendBypass("screw you")
end)

SentencePresets:AddButton("Lgbtq+ is related to autism", function()
    SendBypass("Lgbtq+ is related to autism")
end)
